...
class ResultsActionsProtocol(Protocol):
    ...
    def _get_results_source_rows(self, table: SqlitDataTable, rows: list[tuple[Any, ...]]) -> list[tuple[Any, ...]]:
        ...

    def _get_results_row_at_cursor(self, table: SqlitDataTable, rows: list[tuple[Any, ...]]) -> tuple[Any, ...] | None:
        ...
